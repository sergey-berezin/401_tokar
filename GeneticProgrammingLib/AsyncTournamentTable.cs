namespace GeneticProgrammingLib {
    public class AsyncTournamentTable {
        ...
        private AsyncTournamentTable(Dictionary<int, SortedSet<int>>[] table) {
            Table = table;
            R = table.Count();
            N = table[0].Count() * 2;
        }
        public AsyncTournamentTable(int r, int n, int K) {
            R = r; N = n;
        ...
        public AsyncTournamentTable Mutate(int K, int rounds=1, int pairs=1) {
            ...
            return new AsyncTournamentTable(new_table);
        }
        public AsyncTournamentTable Crossover(AsyncTournamentTable other) {
            Random rnd = new Random();
            Dictionary<int, SortedSet<int>>[] new_table = new Dictionary<int, SortedSet<int>>[R];
